...
class _ProductsState extends State<Products> {
  ...
  String symbol = '';
  String url = 'https://www.youtube.com/watch?v=l3Jvigvxsvc&ab_channel=TheInspiringDad';
        ...
        : Container(
            child: (gridView)
              ...
              shrinkWrap: true,
                    ...
                    }, separatorBuilder: (BuildContext context, int index) => Container(height: 10,color: Colors.white,),
                  ),
          );
  }
