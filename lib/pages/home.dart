        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            TextButton(
              ...
              child: Icon(MdiIcons.syncIcon,color: Colors.orange,)
            ),
            TextButton(
              onPressed: () async {
                ...
                count: 5,
                  child: GestureDetector(
                    onTap: (){
                      ...
                      child: Icon(IconBroken.Notification,color: Color(0xff4c53a5),)))
            ],
          ),
          leadingWidth: 75,
        ),
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              statistics(),
              SizedBox(height: 30,),
              Column( //TODO Make this if client choose to i hope he dose not
          children: [
            Row(
                      ...
                      child: Column(
                        ...
                        children: [
                         Text(AppLocalizations.of(context)
                             .translate('language'),style: TextStyle(color: Color(0xff4c53a5)),),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(AppLocalizations.of(context)
                              .translate('expenses'),style: TextStyle(color: Color(0xff4c53a5)),),
                        ...
                        children: [
                          Center(
                            child: Text(AppLocalizations.of(context)
                                .translate('contact_payment'),style: TextStyle(fontSize: 12,color: Color(0xff4c53a5)),),
                          ),
                        ],
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Center(
                            child: Text(AppLocalizations.of(context)
                                .translate('follow_ups'),style: TextStyle(color: Color(0xff4c53a5),fontSize: 12),),
                          ),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(AppLocalizations.of(context)
                              .translate('suppliersC'),style: TextStyle(color: Color(0xff4c53a5),fontSize: 12),),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(AppLocalizations.of(context)
                              .translate('shipment'),style: TextStyle(color: Color(0xff4c53a5)),),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(AppLocalizations.of(context)
                              .translate('payments'),style: TextStyle(color: Color(0xff4c53a5),fontSize: 12),),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(AppLocalizations.of(context)
                              .translate('reports'),style: TextStyle( color: Color(0xff4c53a5)),),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(AppLocalizations.of(context)
                              .translate('settings'),style: TextStyle( color: Color(0xff4c53a5)),),
...
//homepage drawer
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  Visibility(
                    ...
                    child: ListTile(
                      leading: Image.asset('assets/images/money.png',color: Color(0xff42855B),width: 30,),
                      onTap: () async {
                        if (await Helper().checkConnectivity()) {
                          Navigator.pushNamed(context, '/expense');
                        } else {
                  ...
                  ListTile(
                    leading: Image.asset('assets/images/payed_money.png',color: Color(0xff820000),width: 30,),
                    title: Text(
                  ...
                  ListTile(
                    leading:Image.asset('assets/images/support.png',color: Color(0xff301E67),width: 30,),
                    title: Text(
                  ...
                  ListTile(
                    leading: Image.asset('assets/images/contact.png',color: Color(
                        0xff0064e5),width: 30,),
                    title: Text(
                  ...
                  ListTile(
                    leading: Image.asset('assets/images/delivery.png',color: Color(0xffF2921D),width: 30,),
                    title: Text(
  ...
  block({Color? backgroundColor, String? subject, amount,String? image}) {
      ...
      child: GridView.count(
          ...
          children: <Widget>[
            block(
              ...
              backgroundColor: Color(0xffFF9F29),
            ...
            block(
              ...
              backgroundColor: Color(0xff3C6255),
                image: 'assets/images/total_sales.png'
            ),
            block(
              amount: '$businessSymbol ' +
              ...
              subject: AppLocalizations.of(context).translate('paid_amount'),
                ...
                image: 'assets/images/payed_money.png'
            ...
            block(
              ...
              subject: AppLocalizations.of(context).translate('due_amount'),
                ...
                image: 'assets/images/recived_money.png'
            ),
          ]),
    );
  }
